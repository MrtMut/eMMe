...
nav_menu_admin.innerHTML = `<ul class="nav_menu_items_admin">
    ...
    <li class=" nav_menu_item_admin"><a class="nav_menu_link nav_menu_link_admin"  href="./proyectos.html">Proyectos </a></li>
    <li class=" nav_menu_item_admin"><a class="nav_menu_link nav_menu_link_admin" href="./create.html">Create</a></li>
    <li class=" nav_menu_item_admin"><a class="nav_menu_link nav_menu_link_admin" href="./edit.html">Edit</a></li>
    <li class=" nav_menu_item_admin"><a class="nav_menu_link nav_menu_link_admin" href="./delete.html">Delete</a></li>
                            </ul>`;